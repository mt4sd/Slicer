...
void qSlicerAppMainWindowPrivate::setupUi(QMainWindow * mainWindow)
{
  ...
  helpVisualBlogAction->setToolTip(qSlicerAppMainWindow::tr("Open your favorite web browser to http://"
	  "www.slicer.org/slicerWiki/index.php/Slicer3:VisualBlog where you can post screenshots of interesting"
	  " ways you are using the Slicer3 software package in your research and share them with the Slicer"
	  " community."));
